...
export PATH=$PATH:"$NOTES_PATH":"/Users/$USERNAME/Library/Preferences/"
...
# For IBM Notes, Use Java 1.5.0
# JAVA_COMMAND="$JAVA_PATH "
# JAVA_COMMAND="/System/Library/Frameworks/JavaVM.framework/Versions/1.6.0/Commands/java -d32 "
JAVA_COMMAND="/System/Library/Frameworks/JavaVM.framework/Versions/1.5.0/Commands/java -d32 "
